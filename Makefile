...
# Configurations
INSTALL-MOD-PATH = /lib/modules/2.6.16-rc6/vmregress
KERNELDIR = /usr/src/patchset-0.5/kernels/linux-2.6.16-rc6-zbuddy-v7
...
SUBDIRS = core bench sense test template
...
#KDIR := /lib/modules/2.6.16-rc6/build
KDIR  := /usr/src/patchset-0.5/kernels/linux-2.6.16-rc6-zbuddy-v7
PWD  := $(shell pwd)
